...
export const NewsApiOutput =    ({responseData,nerOutputClick}) => {
    return(
        // Mapping through the response object to render the items  added by Vidyasagar
            ...
            <Accordion.Collapse eventKey={i === 0 ? "0" : i}>
                <Card.Body>
                    ...
                    <div className="row m-3 float-right">
                        <div className="col-md-4">
                            <button className="btn btn-primary btn-sm btn-general" onClick={() => nerOutputClick(outputItem, true)}>NER</button>
                        </div>
                    </div>
                </Card.Body>
            </Accordion.Collapse>
