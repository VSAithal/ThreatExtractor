...
class App extends Component {
  ...
  handleNEROutputClick = (nerOutputContent,nerClickBoolean)=> {//, nerOutputTitle, nerClickBoolean) => {
    ...
    // creating a variable to store the NERcontent (the clicked item) | added by Vidyasagar
         ...
         {this.state.loaderDisplay 
          ...
          <React.Fragment>
            ...
            <div className="container">
              {/* Check if either of the NYoutput, NewsAPIoutput or userFeedoutput or isUserFeedSpacyOutput booleans is true and also any of the corresponding output state object is true? | added by Vidyasagar */}
                  ...
                  ?
                  <div className="row">
                    {/* The display of the NER spacy output will be done based on the isNERClickOutput boolean output  | added by Vidyasagar*/}
                    ...
                    :
                    <>
                    {/* Check if we have the User feed spacy output if true show userFeedSpacy component else check other conditions | added by Vidyasagar */}
